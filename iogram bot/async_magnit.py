...
async def collect_data(city_code='2398'):
    ...
    headers = {
        'Acept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
    ...
    #     src = file.read()
        ...
        data = []
        for card in cards:
            # дополнительно обернул все в try
            try:
                ...
                card_old_price = f'{card_price_old_decimal}.{card_price_old_integer}'
                ...
                card_price = f'{card_price_decimal}.{card_price_integer}'
